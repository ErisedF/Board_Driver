/*寄存器基地址*/
#define CCM_BASE					(0X020C4000)        /*18.6 CCM Memory Map/Register Definition*/
#define CCM_ANALOG_BASE				(0X020C8000)        /*18.7 CCM Analog Memory Map/Register Definition*/
#define IOMUX_SW_MUX_BASE			(0X020E0014)        /*IOMUXC Memory Map/Register Definition*/
#define IOMUX_SW_PAD_BASE			(0X020E0204)        
#define GPIO1_BASE                  (0x0209C000)        /*28.5 GPIO Memory Map/Register Definition*/
